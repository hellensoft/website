...
<form action="{$_SERVER.PHP_SELF}" method="post" name="two">
  <table cellspaing="0" cellpadding="5" class="border">
    ...
    <tr class="light">
      <td>{$lang.hostname}:</td>
      <td><input type="text" name="host" value="sdb-i.hosting.stackcp.net" size="20" /></td>
    </tr>
    <tr class="light">
      <td>{$lang.database}:</td>
      <td><input type="text" name="database" value="helpcenterlive-31383909ad" size="20" /></td>
    </tr>
    <tr class="light">
      <td>{$lang.username}:</td>
      <td><input type="text" name="username" value="helpcenterlive-31383909ad" size="20" /></td>
    </tr>
    <tr class="light">
      <td>{$lang.password}:</td>
      <td><input type="text" name="password" value="8c3e787f12ae" size="20" /></td>
    </tr>
    <tr class="light">
      <td>{$lang.prefix}:</td>
